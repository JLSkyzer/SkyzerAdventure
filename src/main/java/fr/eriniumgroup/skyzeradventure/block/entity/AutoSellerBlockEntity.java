...
public class AutoSellerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public AutoSellerBlockEntity(BlockPos position, BlockState state) {
		super(SkyzeradventureModBlockEntities.AUTO_SELLER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("auto_seller");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new AutoSellerGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
