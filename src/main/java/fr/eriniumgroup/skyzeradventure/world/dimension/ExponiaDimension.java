package fr.eriniumgroup.skyzeradventure.world.dimension;
...
public class ExponiaDimension {
	@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
	public static class ExponiaSpecialEffectsHandler {
		@SubscribeEvent
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("skyzeradventure:exponia"), customEffect));
		}
	}
}