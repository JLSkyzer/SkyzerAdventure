...
public class CastleBossEntity extends Monster {
	...
	public CastleBossEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SkyzeradventureModEntities.CASTLE_BOSS.get(), world);
	}

	public CastleBossEntity(EntityType<CastleBossEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 20;
		setNoAi(false);
		setCustomName(new TextComponent("Castle Boss"));
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.02, true) {
			@Override
